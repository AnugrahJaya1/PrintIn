...
class WCFMmp_Store_Lists_Radius_Filter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
		<input type="text" id="wcfmmp_radius_addr" name="wcfmmp_radius_addr" class="wcfmmp-radius-addr" placeholder="<?php esc_attr_e( 'Insert your addess ..', 'wc-multivendor-marketplace' ); ?>" value="" />
